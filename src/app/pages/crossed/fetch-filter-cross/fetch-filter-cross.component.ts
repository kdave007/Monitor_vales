...
@Component({
  selector: 'app-fetch-filter-cross',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule
  ],
  templateUrl: './fetch-filter-cross.component.html',
  styleUrl: './fetch-filter-cross.component.scss',
  providers: [{ provide: LOCALE_ID, useValue: 'es' }]
})
export class FetchFilterCrossComponent {
